			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('anggota/PantauanHarian/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">
						...
						<?php foreach ($PantauanHarian as $datpan) : ?>
							...
							<form action="<?php echo site_url('anggota/PantauanHarian/edit'); ?>" method="POST" enctype="multipart/form-data">
								<!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
							oleh controller tempat vuew ini digunakan. Yakni index.php/anggota/UangKas/edit/ID --->
