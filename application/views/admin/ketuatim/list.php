			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a class="btn btn-primary" href="<?php echo site_url('admin/KetuaTim/input') ?>"><i class="fas fa-plus"></i> Tambah Data</a>
					</div>
					<div class="card-body">
						...
						<div class="table-responsive">
							<table class="table table-hover text-center" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									<?php 
									$no = 1;
									foreach ($KetuaTim as $ketuatim) : ?>
										<tr>
											<td class="10">
												<?php echo $no++ ?>
											</td>
											<td class="200">
												<?php echo $ketuatim->nama_ketuatim ?>
											</td>
											<td width="200">
												<?php echo dateindo($ketuatim->tgl_lahir) ?>
											</td>
											<td width="150">
												<?php echo $ketuatim->jml_ang_tim ?>
											</td>
											<td width="150">
												<?php echo $ketuatim->nama_tim ?>
											</td>
											<td width="150">
