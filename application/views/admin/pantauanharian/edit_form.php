					...
					<?php foreach ($PantauanHarian as $datpan) : ?>
						...
						<form action="<?php echo site_url('admin/PantauanHarian/edit'); ?>" method="POST" enctype="multipart/form-data">
							...
							<!-- <div class="form-group">
								...
								<div>
									<input type="radio" name="jenis_kelamin" id="jenis_kelamin" value="Laki-laki" <?php echo ($datpan->jenis_kelamin == 'Laki-laki' ? ' checked' : ''); ?>> Laki-laki
									<input type="radio" name="jenis_kelamin" id="jenis_kelamin" value="Perempuan" <?php echo ($datpan->jenis_kelamin == 'Perempuan' ? ' checked' : ''); ?>> Perempuan
								</div>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('suhu') ? 'is-invalid':'' ?>" type="number" name="suhu" placeholder="Nama Warga" value="<?php echo $datpan->suhu; ?>" />
							</div>

							<div class="form-group">
								<label for="arus">Arus</label>
								<input class="form-control <?php echo form_error('arus') ? 'is-invalid':'' ?>" type="number" name="arus" placeholder="Nama Warga" value="<?php echo $datpan->arus; ?>" />
							</div>

							<div class="form-group">
								<label for="cosphi">cosphi</label>
								<input class="form-control <?php echo form_error('cosphi') ? 'is-invalid':'' ?>" type="number" name="cosphi" placeholder="Nama Warga" value="<?php echo $datpan->cosphi; ?>" />
							</div>

							<div class="form-group">
								<label for="cosphi">Tegangan</label>
								<input class="form-control <?php echo form_error('tegangan') ? 'is-invalid':'' ?>" type="number" name="tegangan" placeholder="Nama Warga" value="<?php echo $datpan->tegangan; ?>" />
							</div>

							<!-- <div class="form-group">
								<label for="jenis_konfirmasi">Jenis Konfirmasi</label>
								<div>
									<input type="radio" name="jenis_konfirmasi" id="jenis_konfirmasi" value="ODP" <?php echo ($datpan->jenis_konfirmasi == 'ODP' ? ' checked' : ''); ?>> ODP
									<input type="radio" name="jenis_konfirmasi" id="jenis_konfirmasi" value="PDP" <?php echo ($datpan->jenis_konfirmasi == 'PDP' ? ' checked' : ''); ?>> PDP
									<input type="radio" name="jenis_konfirmasi" id="jenis_konfirmasi" value="OTG" <?php echo ($datpan->jenis_konfirmasi == 'OTG' ? ' checked' : ''); ?>> OTG
								</div>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('tgl_pantauan') ? 'is-invalid':'' ?>"
								type="date" name="tgl_pantauan" placeholder="tgl_pantauan" value="<?php echo $datpan->tgl_pantauan ?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								type="date" name="gambar" placeholder="gambar" value="<?php echo $datpan->gambar ?>"/>
								<div class="invalid-feedback">
